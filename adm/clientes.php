...
<body class="bg-dark">
	...
	<div class="container" id="main" style="padding-bottom: 50px;">
		<div class="big-title">Lista de clientes</div>
				...
				<tbody>
					...
					while ($row = mysqli_fetch_assoc($query)) {
						...
						<tr>
							...
							<td>
								<a href="editar-usuario.php?codigo=<?php echo $codigoU; ?>&nome=<?php echo $nomeQ; ?>&sobrenome=<?php echo $sobrenome; ?>&telefone=<?php echo $telefone; ?>&email=<?php echo $email; ?>&bairro=<?php echo $bairro; ?>&rua=<?php echo $rua; ?>&numero=<?php echo $numero; ?>&complemento=<?php echo $complemento; ?>">
									<img src="../arquivos/editar.png" class="icone" />
								</a>
							</td>
							<td>
								<a href="../php/excluir_cliente.php?codigo=<?php echo $codigoU; ?>">
